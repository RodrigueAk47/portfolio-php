		...
		?>
			<form role="setupForm" method="post" action="setup.php">
				...
				<div class="form-group">
					...
					<button type="submit" class="btn btn-default"><i class='fa fa-fw fa-save'></i> Valider</button>
					<button type="reset" class="btn btn-default"><i class='fa fa-fw fa-refresh'></i>Restaurer</button>
