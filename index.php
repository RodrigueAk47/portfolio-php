    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top"><i class="fa fa-github"></i>&nbsp;<?php echo $rowLanding["heading"];?></a>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-lg-offset-0 text-center">  
                	<p>Moi c'est ASSOHOU AHOUA GUY RODRIGUE <br> et je suis passionné du we et mon but est <br> de
                	devenir developpeur web fullstack</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <form name="sentMessage" id="contactForm" method="post" action="mail/contact_me.php">
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Name</label>
                                <input type="text" class="form-control" placeholder="Nom" id="name" name="name" maxlength="25" required data-validation-required-message="S'il vous plait entré votre nom.">
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="email" class="form-control" placeholder="Adresse email" id="email" name="email" pattern="(?!(^[.-].*|[^@]*[.-]@|.*\.{2,}.*)|^.{254}.)([a-zA-Z0-9!#$%&amp;'*+\/=?^_`{|}~.-]+@)(?!-.*|.*-\.)([a-zA-Z0-9-]{1,63}\.)+[a-zA-Z]{2,15}" maxlength="25"  required data-validation-required-message="S'il vous plait entré votre adresse email.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="tel" class="form-control" placeholder="numero de telephone" id="phone" name="phone" maxlength="25" required data-validation-required-message="S'il vous plait entré votre numero.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Message</label>
                                <textarea rows="5" class="form-control" placeholder="Message" id="message" name="message" maxlength="255" required data-validation-required-message="S'il vous plait entré votre message."></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
						...
						<?php
							if ($_GET["msgsent"]=="thankyou") {
								echo "<div id='success'><div class='alert alert-success'><button type='button' class='close' data-dismiss='alert' aria-hidden='true' onclick=\"window.location.href='index.php#contact'\">×</button><strong>Votre message a été envoyé. </strong></div></div>";
							} elseif ($_GET["msgsent"]=="error") {
								echo "<div id='success'><div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true' onclick=\"window.location.href='index.php#contact'\">×</button><strong>Une erreur est suvenir. </strong></div></div>";
							}
						?>
    ...
    <footer class="text-center">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <p class="col-lg-12">
                        Copyright &copy; <?php echo "Rodrigue Assohou &nbsp;" .date("Y");?></p>
                        <a href="https://github.com/RodrigueAk47/Mon-portfolio">Source Code GitHub</a>
                    </div>
                </div>
            </div>
        </div>
